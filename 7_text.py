...
# 배경 이미지 불러오기 
background = pygame.image.load("C:/Users/653dl/OneDrive/바탕 화면/oss/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/653dl/OneDrive/바탕 화면/oss/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/653dl/OneDrive/바탕 화면/oss/pygame_basic/enemy.png")
...
while running:
    ...
    # print("fps : " + str(clock.get_fps())) # 프레임값 터미널 출력
    ...
    # 충돌 체크
    if character_rect.colliderect(enemy_rect):   # colliderect()  사각형 기준 충돌 있었는지 확인
        print("충돌했어요")
        running = False
    ...
    timer = game_font.render(str(int(total_time - elapsed_time)), True, (255, 255, 255))  # render() 글자 그리는
    # 출력할 글자, ture, 글자 색상
